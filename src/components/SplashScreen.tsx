...
export default function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  const assetUrls = [
    ...
    'assets/preview.png',
    'assets/alien.png',
    'assets/powerup-shield.png',
    'assets/powerup-gun.png',
    'assets/powerup-life.png',
    'assets/player.png',
    'assets/arrow.png',
    'assets/minibos/ufo2.png',
    'assets/minibos/ufo3.png',
    'assets/minibos/ufo4.png',
    ...Array.from({ length: 25 }, (_, i) => `assets/minibos/ufo5/green_ufo_gmc_${i.toString().padStart(4, '0')}.png`)
  ];
